<ul class="fixed z-10 bottom-0 right-0 flex flex-col sm:flex-row flex-wrap mb-3 mr-3 opacity-75">
    <li class="cursor-pointer text-xs mr-1 mb-1 rounded px-2 py-1 bg-gray-100 text-gray-800 uppercase hover:bg-white hover:text-gray-900"><a rel="me" href="https://github.com/talvbansal/jigsaw-photo-stream" title="Fork on Github">Fork on Github</a></li>
